...
class _SpotsState extends State<Spots> {
  ...
  List video = [
    'https://assets.mixkit.co/videos/preview/mixkit-one-on-one-in-a-soccer-game-43483-large.mp4',
    'https://assets.mixkit.co/videos/preview/mixkit-talented-freestyle-soccer-player-juggling-the-ball-43519-large.mp4',
    'https://assets.mixkit.co/videos/preview/mixkit-hands-of-a-soccer-team-making-a-cheer-43479-large.mp4',
  ];
  @override
  void initState() {
